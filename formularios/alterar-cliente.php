  ...
  <?php
   @session_start();
        ...
        if ($_SESSION['login'] == true) {
            $perfis = mysqli_query($con, "SELECT * FROM `cadastro_login_cliente` WHERE `cadastro_login_cliente`.`cod` = '$_SESSION[cod]'");
        } else if ($_SESSION['login'] == false) {
            $perfis = mysqli_query($con, "SELECT * FROM `tb_cliente_juridico` WHERE `tb_cliente_juridico`.`cod`= '$_SESSION[cod]'");
        }
        ...
        <div class="row gx-5">
            <div class="col-md-6">
                ...
                <form method="post" action="alterar-cliente.act.php">
                    ...
                    <div class="form-floating mb-3">
                    <p><input type="text" class="form-control" name="cpf" placeholder="Digite seu cpf" value="<?php echo $perfil['cpf']?>"></p>
                    </div>
                    <div class="form-floating mb-3">
                    <p><input type="text" class="form-control"  name="cnpj" placeholder="Digite seu cnpj" value="<?php echo $perfil['cnpj']?>"></p>
                    </div>
                    <div class="form-floating mb-3">
