  ...
  ?>
    ...
    <div class="container col-11 col-md-9 mt-4" id="form-container">
        <div class="row gx-5">
            <div class="col-md-6">
                <h2>ADVOGADO</h2>
                <form method="post" action="registerAdv.act.php">
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="last-name" name="cpf_adv" placeholder="Digite seu cpf">
                        <label for="endereco" class="form-label">cpf<label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control" id="last-name" name="genero" placeholder="Digite seu genero">
                        <label for="genero" class="form-label">genero<label>
                    </div>
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control" id="last-name" name="data_nascimento" placeholder="digite sua data de nascimento">
